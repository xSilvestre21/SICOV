          ...
          <CardBody className="space-y-2">
            ...
            {form.priceTable.map((row, i) => (
              <div key={i} className="flex flex-wrap gap-2 items-center p-2 bg-[#f5f5ee] rounded-lg">
                ...
                <input type="number" step="any" value={row.limitFactorKg || ''} onChange={(e) => updatePriceRow(i, 'limitFactorKg', e.target.value)} placeholder="Limite" className="w-24 rounded-lg border border-[#b0b087] px-3 py-1.5 text-sm outline-none focus:border-[#58706d]" />
